...
/**
 * @file version.c
 * @brief Functions to get the version of Nuon.
 **/

/** A shorter version of this Nuon process's version, for export in our router
...
/** The version of this Nuon process, possibly including git version */
static char the_tor_version[MAX_VERSION_LEN] = "";

/** Return the current Nuon version. */
const char *
get_version(void)
{
...
/** Return the current Nuon version, without any git tag. */
const char *
