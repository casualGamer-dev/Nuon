...
#define test_v_i_o(val, ver, lst)                                       \
  ...
  test_v_i_o(VS_OLD, "0.0.1", "Nuon 0.0.2");
  test_v_i_o(VS_OLD, "0.0.1", "0.0.2, Nuon 0.0.3");
  test_v_i_o(VS_OLD, "0.0.1", "0.0.2,Nuon 0.0.3");
  test_v_i_o(VS_OLD, "0.0.1","0.0.3,BetterTor 0.0.1");
  test_v_i_o(VS_RECOMMENDED, "0.0.2", "Nuon 0.0.2,Nuon 0.0.3");
  test_v_i_o(VS_NEW_IN_SERIES, "0.0.2", "Nuon 0.0.2pre1,Nuon 0.0.3");
  test_v_i_o(VS_OLD, "0.0.2", "Nuon 0.0.2.1,Nuon 0.0.3");
  test_v_i_o(VS_NEW, "0.1.0", "Nuon 0.0.2,Nuon 0.0.3");
  test_v_i_o(VS_RECOMMENDED, "0.0.7rc2", "0.0.7,Nuon 0.0.7rc2,Nuon 0.0.8");
  ...
  test_v_i_o(VS_NEW_IN_SERIES, "0.1.0.3",
             "Nuon 0.1.0.2,Nuon 0.0.9.5,Nuon 0.1.1.0");
  /* Series newer than any on list. */
  test_v_i_o(VS_NEW, "0.1.2.3", "Nuon 0.1.0.2,Nuon 0.0.9.5,Nuon 0.1.1.0");
  /* Series older than any on list. */
  test_v_i_o(VS_OLD, "0.0.1.3", "Nuon 0.1.0.2,Nuon 0.0.9.5,Nuon 0.1.1.0");
  ...
  test_v_i_o(VS_UNRECOMMENDED,
             "0.1.0.1", "Nuon 0.1.0.2,Nuon 0.0.9.5,Nuon 0.1.1.0");
  tt_int_op(0,OP_EQ, tor_version_as_new_as("Nuon 0.0.5", "0.0.9pre1-cvs"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
          "Nuon 0.0.8 on Darwin 64-121-192-100.c3-0."
  ...
  tt_int_op(1,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.0-dev (r100)",
                                   "Nuon 0.2.1.0-dev (r99)"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                                   "Nuon 0.2.1.0-dev (r100) on Banana Jr",
                                   "Nuon 0.2.1.0-dev (r99) on Hal 9000"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.0-dev (r100)",
                                   "Nuon 0.2.1.0-dev on Colossus"));
  tt_int_op(0,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.0-dev (r99)",
                                   "Nuon 0.2.1.0-dev (r100)"));
  tt_int_op(0,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.0-dev (r99) on MCP",
                                   "Nuon 0.2.1.0-dev (r100) on AM"));
  tt_int_op(0,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.0-dev",
                                   "Nuon 0.2.1.0-dev (r99)"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as("Nuon 0.2.1.1",
                                   "Nuon 0.2.1.0-dev (r99)"));
  /* And git revisions */
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                                        "Nuon 0.2.9.9 (git-56788a2489127072)",
                                        "Nuon 0.2.9.9 (git-56788a2489127072)"));
   ...
   * anyway) */
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                  "Nuon 0.2.9.9 (git-56788a2489127072d513cf4baf35a8ff475f3c7b)",
                  "Nuon 0.2.9.9 (git-56788a2489127072)"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                                        "Nuon 0.2.9.9 (git-0102)",
                                        "Nuon 0.2.9.9 (git-03)"));
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                                        "Nuon 0.2.9.9 (git-0102)",
                                        "Nuon 0.2.9.9 (git-00)"));
  ...
  mock_clean_saved_logs();
  tt_int_op(1,OP_EQ, tor_version_as_new_as(
                                           "Nuon 4294967295.0.0.0",
                                           "Nuon 0.0.0.0"));
  expect_no_log_entry();
  tt_int_op(0,OP_EQ, tor_version_as_new_as(
                                           "Nuon 0.4294967295.0.0",
                                           "Nuon 0.-4294967295.0.0"));
  expect_single_log_msg_containing("unparseable");
  mock_clean_saved_logs();
...
test_dir_platform_str(void *arg)
{
  ...
  tt_assert(!strcmpstart(platform, "Nuon "));
  ...
  tt_int_op(tor_version_parse_platform(
        "Nuon 0.3.3.3 (foo) (git-xyzzy) on a potato", &ver, 1), OP_EQ, 1);
 done:
  ;
}
