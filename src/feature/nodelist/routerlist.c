 ...
 * descriptor, as generated by a Nuon relay in order to tell the rest of
 ...
 *
 * Almost nothing in Nuon should use a routerinfo_t to refer directly to
                                  ...
                                  int descriptor_digests)
{
  ...
  SMARTLIST_FOREACH_BEGIN(extrainfo_list, extrainfo_t *, ei) {
      ...
      if (WRA_WAS_ADDED(added) && requested_fingerprints) {
         ...
         * inside Nuon, this should be harmless. */
